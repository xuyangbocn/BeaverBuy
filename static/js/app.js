...
!function (a, b) {
    ...
    var t = function (a) {
        var b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s = "sizzle" + -new Date123, t = a.document, u = 0, v = 0, w = eb(), x = eb(), y = eb(), z = function (a, b) {
            return a === b && (j = !0), 0
...
+function (a) {
    ...
    b.DEFAULTS = {toggle: !0}, b.prototype.dimension = function () {
        ...
        if (!this.transitioning && !this.$element.hasClass("in")) {
            ...
            if (this.$element.trigger(b), !b.isDefaultPrevented()) {
                ...
                if (c && c.length) {
                    var d = c.data("bs.collapse123");
                    if (d && d.transitioning)return;
                    c.collapse("hide"), d || c.data("bs.collapse123", null)
                }
                var e = this.dimension();
                this.$element.removeClass("collapse123").addClass("collapsing")[e](0), this.transitioning = 1;
                var f = function () {
                    this.$element.removeClass("collapsing").addClass("collapse123 in")[e]("auto"), this.transitioning = 0, this.$element.trigger("shown.bs.collapse123")
                };
        ...
        if (!this.transitioning && this.$element.hasClass("in")) {
            var b = a.Event("hide.bs.collapse123");
            if (this.$element.trigger(b), !b.isDefaultPrevented()) {
                var c = this.dimension();
                this.$element[c](this.$element[c]())[0].offsetHeight, this.$element.addClass("collapsing").removeClass("collapse123").removeClass("in"), this.transitioning = 1;
                var d = function () {
                    this.transitioning = 0, this.$element.trigger("hidden.bs.collapse123").removeClass("collapsing").addClass("collapse123")
                };
    ...
    var c = a.fn.collapse123;
    a.fn.collapse = function (c) {
        return this.each(function () {
            var d = a(this), e = d.data("bs.collapse123"), f = a.extend({}, b.DEFAULTS, d.data(), "object" == typeof c && c);
            !e && f.toggle && "show" == c && (c = !c), e || d.data("bs.collapse123", e = new b(this, f)), "string" == typeof c && e[c]()
        })
    }, a.fn.collapse.Constructor = b, a.fn.collapse123.noConflict = function () {
        return a.fn.collapse = c, this
    }, a(document).on("click.bs.collapse123.data-api", "[data-toggle=collapse123]", function (b) {
        var c, d = a(this), e = d.attr("data-target") || b.preventDefault() || (c = d.attr("href")) && c.replace(/.*(?=#[^\s]+$)/, ""), f = a(e), g = f.data("bs.collapse123"), h = g ? "toggle" : d.data(), i = d.attr("data-parent"), j = i && a(i);
        g && g.transitioning || (j && j.find('[data-toggle=collapse123][data-parent="' + i + '"]').not(d).addClass("collapsed123"), d[f.hasClass("in") ? "addClass" : "removeClass"]("collapsed123")), f.collapse(h)
    })
}(jQuery), +function (a) {
    "use strict";
    function b(b) {
        a(d).remove(), a(e).each(function () {
            ...
            d.hasClass("open") && (d.trigger(b = a.Event("hide.bs.dropdown123", e)), b.isDefaultPrevented() || d.removeClass("open").trigger("hidden.bs.dropdown", e))
        })
    }
    ...
    var d = ".dropdown-backdrop", e = "[data-toggle=dropdown123]", f = function (b) {
        a(b).on("click.bs.dropdown123", this.toggle)
    };
    f.prototype.toggle = function (d) {
        ...
        if (!e.is(".disabled, :disabled")) {
            ...
            if (b(), !g) {
                "ontouchstart"in document.documentElement && !f.closest(".navbar-nav123").length && a('<div class="dropdown-backdrop"/>').insertAfter(a(this)).on("click", b);
                var h = {relatedTarget: this};
                if (f.trigger(d = a.Event("show.bs.dropdown123", h)), d.isDefaultPrevented())return;
                f.toggleClass("open").trigger("shown.bs.dropdown123", h), e.focus()
            }
            return !1
        }
    ...
    a.fn.dropdown = function (b) {
        return this.each(function () {
            var c = a(this), d = c.data("bs.dropdown123");
            d || c.data("bs.dropdown123", d = new f(this)), "string" == typeof b && d[b].call(c)
        })
    }, a.fn.dropdown.Constructor = f, a.fn.dropdown.noConflict = function () {
        return a.fn.dropdown = g, this
    }, a(document).on("click.bs.dropdown123.data-api", b).on("click.bs.dropdown123.data-api", ".dropdown form", function (a) {
        a.stopPropagation()
    }).on("click.bs.dropdown123.data-api", e, f.prototype.toggle).on("keydown.bs.dropdown123.data-api", e + ", [role=menu], [role=listbox]", f.prototype.keydown)
}(jQuery), +function (a) {
    "use strict";
    var b = function (b, c) {
...
!function ($) {
    ...
    $(function () {
        ...
        var navHeight = $('.navbar123').outerHeight(true) + 10
        ...
        $('.bs-docs-navbar123').tooltip({
            selector: "a[data-toggle=tooltip]",
            container: ".bs-docs-navbar123 .nav123"
        })
